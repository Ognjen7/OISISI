...
public class DeleteSoftveri extends JDialog {

	private JPanel contentPane;

	public DeleteSoftveri(int selectedRowIndex) {
		...
		JLabel lblNewLabel = new JLabel("Da li ste sigurni da zelite da obrisete softver: " + MainApp.softveri.get(selectedRowIndex).getNaziv() + "?");
