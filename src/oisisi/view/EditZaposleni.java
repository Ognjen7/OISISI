...
public class EditZaposleni extends JDialog {
	...
	public static Zaposleni zaposleniEdit;

	public EditZaposleni(int selectedRowIndex) {
		
		zaposleniEdit = MainApp.zaposleni.get(selectedRowIndex);
		...
		JLabel lblNewLabel = new JLabel("Izmenite ime:");
		...
		txtIme_1.setText(zaposleniEdit.getIme());
		...
		JLabel lblNewLabel_1 = new JLabel("Izmenite prezime:");
		...
		txtIme.setText(zaposleniEdit.getPrezime());
		...
		JLabel lblNewLabel_2 = new JLabel("Izmenite jmbg");
		...
		txtJmbg.setText(zaposleniEdit.getJmbgToString());
		...
		JLabel lblNewLabel_3 = new JLabel("Izmenite datum rodjenja(DD.MM.GGGG):");
		...
		txtEmail.setText(zaposleniEdit.getEmail());
		...
		JLabel lblNewLabel_5 = new JLabel("Izmenite adresu stanovanja(Ulica, Broj, Grad):");
		...
		txtUnesiteUlicu.setText(zaposleniEdit.getAdresaStanovanja().getUlica());
		...
		txtUnesiteBroj.setText(String.valueOf(zaposleniEdit.getAdresaStanovanja().getBroj()));
		...
		txtUnesiteGrad.setText(zaposleniEdit.getAdresaStanovanja().getGrad());
		panel_1.add(txtUnesiteGrad);
		txtUnesiteGrad.setColumns(10);
		
		JLabel lblNewLabel_6 = new JLabel("Izmenite softvere:");
		...
		int[] listSelectedValues = new int[zaposleniEdit.getSoftveri().size()];
		int listSelectedValuesIndex = 0;
		...
		list.setSelectedIndices(listSelectedValues);
