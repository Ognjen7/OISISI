...
public class DeleteZaposleni extends JDialog {
	...
	public DeleteZaposleni(int selectedRowIndex) {
		...
		JLabel lblNewLabel = new JLabel("Da li ste sigurni da zelite da obrisete zaposlenog: " + MainApp.zaposleni.get(selectedRowIndex).getIme() + " " + MainApp.zaposleni.get(selectedRowIndex).getPrezime() + "?");
